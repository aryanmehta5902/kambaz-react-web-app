...
import { Link, useNavigate, useParams } from "react-router-dom"; // Fixed import from react-router to react-router-dom
    ...
    if (assignments && assignments.length > 0) {
      const filtered = assignments
        ...
        .filter((assignment: any) => 
          ...
          String(assignment._id).includes(searchTerm)
        );
      setFilteredAssignments(filtered);
    }
  }, [assignments, cid, searchTerm]);
