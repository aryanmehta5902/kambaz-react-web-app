      ...
      <Table striped>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-total-activity">20:45:10</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-last-activity">2020-08-30</td>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-07-25</td>
            <td className="wd-total-activity">12:45:35</td>
          </tr>
        </tbody>
      </Table>
    </div>
